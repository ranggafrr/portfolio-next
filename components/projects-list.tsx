  ...
  return (
    <>
      {projects.map((project, index) => (
        ...
        >
          <Card className="group bg-white/60 border-zinc-200 hover:border-zinc-400 hover:shadow-xl transition-all duration-300 cursor-pointer overflow-hidden grayscale hover:grayscale-0">
